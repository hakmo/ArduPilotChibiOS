...
/**
 * @brief   Macro for working area declaration.
 * @note    Backward-compatibility alias for ArduPilotChibiOS RT kernel v7.0.
 */
...
/* Backward-compatibility aliases for ArduPilotChibiOS RT kernel v7.0.*/
#define port_get_irq_status()   port_get_lock_status()
#define port_irq_enabled(sts)   (!port_is_locked(sts))
